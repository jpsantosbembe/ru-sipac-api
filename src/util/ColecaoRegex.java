...
public class ColecaoRegex {
    public static final String NOME_COMPLETO = "<th\\s*.*>Nome:</th>\\s\\W+<td\\s*.*>(\\s*.*)</td>";
        public static final String MATRICULA = "<td> Matr&#237;cula: </td>\\s\\W+<td\\s*.*>(\\s*.*)</td>";
    ...
    public static final String FOTO_DE_PERFIL = "(http[s]?[\\w\\S]+\\.(?:jpeg|jpg|gif|png|bmp))";
    public static final String USUARIO_SENHA_INVALIDO = "<b>\\s+(Usuário e\\/ou senha inválidos)\\s+<\\/b>";
    public static final String USUARIO_SEM_CADASTRO_RU = "<em>(Voc&#234; n&#227;o possui um cart&#227;o do restaurante)\\.</em>";
